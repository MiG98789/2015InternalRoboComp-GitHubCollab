...
void servo_init(void){
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	//------------------------------//
	TIM_TimeBaseStructure.TIM_Prescaler = 71;												//Timer speed = 72e6/(Prescaler+1) Hz
	TIM_TimeBaseStructure.TIM_Period = 20000;												//Counts per pulse, basically max value for SetCompare
	//------------------------------//50Hz
